...
const TabelGenerator = () => {
    ...
    const priceArrey = []
    const rendementArrey = ["rendement",0]
    const datumArrey = ["datum"]
    ...
    console.log(datumArrey.length)
    console.log(rendementArrey.length)
    return (
        <div>
            <table>
                <thead>
                ...
                <tbody>
                    {datumArrey.map((datum, index) => (
                        <td key = {index}>
                            <tr><th>{datum}</th></tr>
                            <tr>{rendementArrey[index]}</tr>
                        </td>
                    ))}
                </tbody>
            </table>
